...
local myawesomemenu = {
   { "快捷键 (&H)", function() return false, hotkeys_popup.show_help end},
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Mod1" },            "F2",    function () awful.spawn('xfce4-appfinder', false) end,
              {description = "运行应用程序…", group = "launcher"}),
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "c",
        ...
        {description = "place at center", group = "client"})
) -- }}}
